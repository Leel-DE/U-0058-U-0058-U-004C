...
const categorySchema = {
  ...
  properties: {
    ...
    cardOldPriceSelector: { type: 'string', nullable: true },
    cardLinkSelector: { type: 'string', nullable: true },
    cardImageSelector: { type: 'string', nullable: true },
    cardAvailabilitySelector: { type: 'string', nullable: true },
    paginationNextSelector: { type: 'string', nullable: true },
    loadMoreSelector: { type: 'string', nullable: true },
    confidence: { type: 'number' },
    notes: { type: 'array', items: { type: 'string' } },
  },
  required: ['confidence'],
